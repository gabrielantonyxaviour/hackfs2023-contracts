...
contract DealClient is Ownable {
    ...
    constructor(address _theRiotProtocolAddress) {
        riotProtocol = ITheRiotProtocol(_theRiotProtocolAddress);
    }
    ...
    function withdrawBalance(address client, uint256 value) public onlyOwner returns (uint256) {
