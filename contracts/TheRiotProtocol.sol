// File: contracts/riot/RiotOrganisation.sol
...
// File: contracts/riot/TheRiotProtocol.sol
...
contract TheRiotProtocol {
    ...
    function registerOrganisation(
        ...
        addressToOrganisation[address(organisation)] = _organisation;
        organisations[msg.sender].push(_organisation);
    ...
    function getOrganisations() public view returns (Organisation[] memory _organisations) {
        _organisations = organisations[msg.sender];
    }
}
